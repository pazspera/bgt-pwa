...
import { faDice, faUsers, faBoxArchive, faBars, faSun, faMoon, faTrash, faPenToSquare, faPlus, faTriangleExclamation, faChevronDown, faSquare, faCaretDown, faCheck, faCheckSquare, faCalendar, faChevronLeft, faChevronRight, faFloppyDisk, faCircleCheck } from "@fortawesome/free-solid-svg-icons";
...
// Font Awesome
library.add(faDice, faUsers, faBoxArchive, faBars, faSun, faMoon, faTrash, faPenToSquare, faPlus, faTriangleExclamation, faChevronDown, faSquare, faCaretDown, faCheck, faCheckSquare, faCalendar, faChevronLeft, faChevronRight, faFloppyDisk, faCircleCheck);
